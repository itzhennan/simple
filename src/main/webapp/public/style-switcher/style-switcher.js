...
jQuery(document).ready(function($) {
		...
		if (link.length>0) {
			link.attr('href','public/css/skins/' + tp_stylesheet + '.css');
			$('.style-switcher .styleChange li[data-style="'+tp_stylesheet+'"]').addClass("selected");
			if ($(".header-page-dark").length>0) {
				document.getElementById("logo_img").src="public/images/logo_dark_header_" + tp_stylesheet + ".png";
			} else {
				if ($("#logo_img").length>0) {
					document.getElementById("logo_img").src="public/images/logo_" + tp_stylesheet + ".png";
				};
				if ($("#logo-footer").length>0) {
					document.getElementById("logo-footer").src="public/images/logo_" + tp_stylesheet + ".png";
				};
			};
		};
		...
		$('.style-switcher .styleChange li').on('click',function(){
			if (link.length>0) {
				...
				$(".style-switcher .styleChange .selected").removeClass("selected");
				$this.addClass("selected");
				link_no_cookie.attr('href', 'public/css/skins/' + tp_stylesheet_no_cookie + '.css');
				if ($(".header-page-dark").length>0) {
					document.getElementById("logo_img").src="public/images/logo_dark_header_" + tp_stylesheet_no_cookie + ".png";
				} else {
					if ($("#logo_img").length>0) {
						document.getElementById("logo_img").src="public/images/logo_" + tp_stylesheet_no_cookie + ".png";
					};
					if ($("#logo-footer").length>0) {
						document.getElementById("logo-footer").src="public/images/logo_" + tp_stylesheet_no_cookie + ".png";
					};
				};
			};
		});
