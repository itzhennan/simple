function AutoTag(asks,index) {
    if (!jQuery) {
        console.error('需要引用jquery');
        return false;
    }
    if (!Array.prototype.findIndex) {//兼容 IE
    ...
    var leaveFun = function(obj) {
        ...
        setTimeout(function() {
            ...
            _this.one('focusout', function() {
                ...
                var isAlreadyHad = new RegExp(',' + curTxt + '$|,' + curTxt + ',|^' + curTxt + ',|^' + curTxt + '$', 'g');
