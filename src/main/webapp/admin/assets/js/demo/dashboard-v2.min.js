...
var getMonthName = function (t) {
    ...
    $('[data-click="logout"]').click(function() {
        $IEC.doHref($IEC.getCurrentURI()+"/user/logout");
    });
}, initBand = function(){
    logout();
    ...
    return {
        init: function () {
            handleVisitorsAreaChart(), handleVisitorsDonutChart(), handleVisitorsVectorMap(), handleScheduleCalendar(), handleDashboardGritterNotification(),initBand()
        }
    }
}();